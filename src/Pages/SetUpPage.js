                ...
                <form action="#" method="POST">
                    ...
                    <div class="bg-white px-4 py-5 sm:p-6">
                        ...
                        <div class="col-span-6 sm:col-span-3 lg:col-span-4">
                            <label for="region" class="block text-sm font-medium text-gray-700">Time Zone</label>
                            <input type="text" name="region" id="region" autocomplete="address-level1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"/>
                        </div>
            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                ...
                <form action="#" method="POST">
                    ...
                    <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                        ...
                        <div class="text-base font-medium text-gray-900" aria-hidden="true">Phone Number</div>
                        <PhoneInput placeholder="Enter phone number" value={value} onChange={setValue} class="h-4  rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"/>
